...
export function CommandPalette({ className = '' }: CommandPaletteProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-16">
      ...
      {/* Search Modal */}
      <div className={`relative w-full max-w-2xl mx-4 ${className}`}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <span className="flex items-center gap-1">
                  <span className="font-medium text-gray-600">Arrow keys</span>
                  <span>Navigate</span>
                </span>
                <span className="flex items-center gap-1">
                  <span className="font-medium text-gray-600">Enter</span>
                  <span>Select</span>
                </span>
                <span className="flex items-center gap-1">
                  <span className="font-medium text-gray-600">Esc</span>
                  <span>Close</span>
                </span>
              </div>
